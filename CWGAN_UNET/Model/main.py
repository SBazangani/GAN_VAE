...
from Model.UNET import GEN_UNET
...
def MODEL():
    ...
    #optimizerd2 = optim.Adam(gen.parameters(), lr=0.00001, betas=(beta1,beta2))
    # optimizerd2 = optim.RMSprop(gen.parameters(), lr=0.00001,alpha=0.00005)
